...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__load_icon__ = __webpack_require__(9);
...
class Github {
    ...
    static handleResponse(response, expected_code, callback) {
        ...
        if (response.readyState === XMLHttpRequest.DONE) {
            __WEBPACK_IMPORTED_MODULE_1__load_icon__["a" /* default */].hide();
            if (response.status === expected_code) {
                callback(JSON.parse(response.responseText));
                __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#error-message").html("");
            }
            else if (response.status === 204) {
                __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#error-message").html("204 No Content");
            }
            else if (response.status !== 204) {
                __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#error-message").html(Github.formatError(response));
            }
        }
    }
    static GET(url, callback) {
        let request = new XMLHttpRequest();
        const api_key = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#api-key input").val();
        if (api_key === "") {
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#error-message").html("No API key");
            return;
        }
        const auth_basic = window.btoa(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#username input").val() + ":" + __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#api-key input").val());
        ...
        __WEBPACK_IMPORTED_MODULE_1__load_icon__["a" /* default */].show();
        request.send(null);
    }
    static POST(data, url, callback) {
        let request = new XMLHttpRequest();
        let auth_basic = window.btoa(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#username input").val() + ":" + __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#api-key input").val());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__github__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__milestones__ = __webpack_require__(3);
...
class Issues {
    ...
    static createNewIssue() {
        ...
        let milestone = document.getElementById(__WEBPACK_IMPORTED_MODULE_2__milestones__["a" /* default */].ID_ACTIVE_MILESTONE);
...
Issues.retrieve = function () {
    if (window.location.hash.length > 1) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__github__["a" /* default */].GET(repositoryUrl, Issues.show);
    }
};
Issues.show = function (issues) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#new-issue-title").bind("enterKey", Issues.createNewIssue);
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#new-issue-title").keyup(function (e) {
        if (e.keyCode == 13) {
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(this).trigger("enterKey");
        }
    });
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#new-issue-body").bind("enterKey", Issues.createNewIssue);
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#new-issue-body").keyup(function (e) {
        if (e.keyCode == 13) {
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(this).trigger("enterKey");
        }
    });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__github__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__issues__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__site_controls__ = __webpack_require__(7);
...
class Milestones {
    ...
    static markActiveMilestone(id) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__site_controls__["a" /* default */].toggleMilestones();
    ...
    static toggleButtonActiveVisual(enabled) {
        ...
        const disabled_milestone_button_class = "w3-dark-gray";
        const active_milestone_button_class = "w3-green";
        if (enabled) {
...
Milestones.ID_ACTIVE_MILESTONE = "active-milestone";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__github__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pin_manager__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__credential_form__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__issues__ = __webpack_require__(2);
...
class Repositories {
    static retrieve(use_cached = false) {
        if (use_cached && Repositories.repo_cache) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__github__["a" /* default */].GET(__WEBPACK_IMPORTED_MODULE_1__github__["a" /* default */].REPOSITORIES_URL, Repositories.show);
        }
    }
    static show(repositories) {
        ...
        __WEBPACK_IMPORTED_MODULE_3__credential_form__["a" /* default */].hide();
    }
    static makeRows(json_data) {
        ...
        rows = __WEBPACK_IMPORTED_MODULE_2__pin_manager__["a" /* default */].reorder(rows);
    ...
    static filterRepositories(e) {
        let string = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#repo-filter input").val().toLowerCase();
        let repo;
        let repo_row_tag = "#repository-list .w3-row";
        if (string.length > 0) {
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(repo_row_tag).each(function (i, v) {
                if (v.children[0].text.indexOf(string) == -1) {
                    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(this).hide();
                }
                else {
                    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(this).show();
                }
            });
        }
        else {
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(repo_row_tag).show();
        }
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__repositories__ = __webpack_require__(4);
...
class Pinned {
    ...
    static addOrRemove(id) {
        let chosen_repo = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#repo_" + id + " a")[0].text;
        ...
        if (!current || current.indexOf(chosen_repo + ',') == -1) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#repo_" + id + " i")[0].className = 'fa fa-thumb-tack';
        }
        else {
            Pinned.remove(chosen_repo);
            __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#repo_" + id + " i")[0].className = 'fa fa-check';
        }
        ...
        __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()('#repo-filter input').val("");
    }
    static reorder(rows) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__credential_form__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__issues__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__milestones__ = __webpack_require__(3);
...
class Controls {
    ...
    static showCredentials() {
        __WEBPACK_IMPORTED_MODULE_0__credential_form__["a" /* default */].show();
        Controls.toggleRepositoryOptions();
    }
    static toggleMilestones() {
        Controls.toggle_w3_show(document.getElementById(__WEBPACK_IMPORTED_MODULE_1__issues__["a" /* default */].ID_NEW_ISSUE_MILESTONES_LIST));
    }
    static markActiveMilestone(id) {
        __WEBPACK_IMPORTED_MODULE_2__milestones__["a" /* default */].markActiveMilestone(id);
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__build_github__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__build_repositories__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__build_issues__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__build_milestones__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__build_pin_manager__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__build_site_controls__ = __webpack_require__(7);
...
window.Pinned = __WEBPACK_IMPORTED_MODULE_5__build_pin_manager__["a" /* default */];

window.Controls = __WEBPACK_IMPORTED_MODULE_6__build_site_controls__["a" /* default */];

__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(document).on('keyup', "#repo-filter input", __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default.a.proxy(__WEBPACK_IMPORTED_MODULE_2__build_repositories__["a" /* default */].filterRepositories, this));
__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()("#api-key").on('change', function () {
    __WEBPACK_IMPORTED_MODULE_2__build_repositories__["a" /* default */].retrieve();
});
__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(document).ready(function () {
...
__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1___default()(window).on('hashchange', function () {
    __WEBPACK_IMPORTED_MODULE_3__build_issues__["a" /* default */].retrieve();
});
